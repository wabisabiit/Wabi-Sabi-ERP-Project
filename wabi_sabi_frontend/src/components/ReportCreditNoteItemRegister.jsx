...
export default function ReportCreditNoteItemRegister() {
  ...
  // download menu (single icon + menu)
  ...
  const downloadAllDataExcel = () => {
    ...
    downloadBlob(
      new Blob([csv], { type: "text/csv;charset=utf-8" }),
      "credit-note-item-register-all-data.csv"
    );
  };
  const downloadPDF = () => {
      ...
      <div className="cnir-card">
        ...
        <div className="cnir-toolbar">
          ...
          <div className="cnir-actions">
            {/* Download (single icon with menu) */}
            <div className="cnir-download" ref={splitRef}>
              <button
                type="button"
                className="cnir-download-btn"
                aria-label="Download"
                aria-haspopup="menu"
