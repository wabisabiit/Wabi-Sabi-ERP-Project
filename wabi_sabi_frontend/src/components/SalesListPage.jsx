...
export default function SaleListPage() {
    ...
    const fetchRows = async () => {
        ...
        try {
            ...
            const pm = payMode.trim().toUpperCase();
    ...
    }, [page, pageSize, payMode, startDate, endDate]); // searchText will refresh on explicit search click
                ...
                {openFilter && (
                    <>
                        <div className="ol-filters">
                            ...
                            {/* ✅ Customer Number filter (UI only for now) */}
